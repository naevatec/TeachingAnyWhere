package com.naevatec.taw.backend.file;
...
public class FileController {
	...
	public ResponseEntity<Object> handleFileUpload(
		...
		if (teacherAuthorized != null) { // If the user is not the teacher of the course
			...
			while (i.hasNext()) {
				...
				com.naevatec.taw.backend.file.File customFile = new com.naevatec.taw.backend.file.File(1, fileName);
	...
	public void handleFileDownload(
		...
		if (userAuthorized != null) { // If the user is not an attender of the course
			...
			com.naevatec.taw.backend.file.File f = null;
			Path file= null;
			
			try {
				Optional<com.naevatec.taw.backend.file.File> o_f = fileRepository.findById(id_file);
				f = o_f.get();
